...
function ProjectInfo({name, description, image, tech, features, challenges}) {
  ...
  return (
    ...
    className="flex flex-col relative items-center justify-center w-72 p-2 m-4 text-wrap text-white border shadow-2xl rounded-3xl">
        ...
        whileTap={{scale: 0.8}}
        className='text-base font-semibold bg-sky-700 hover:bg-sky-600 text-white p-3 w-1/2 m-2 rounded-2xl  text-center '>Demo</motion.button>
        <motion.button 
        whileHover={{scale: 1.1}}
        whileTap={{scale: 0.9}}
        className='text-base font-semibold bg-black hover:bg-gray-900 text-white mb-8 p-3 w-1/2 rounded-2xl text-center '>GIthub</motion.button>
        <motion.button 
        whileHover={{scale: 1.1}}
        whileTap={{scale: 0.8}}
        ...
        initial={{scale: 0}}
        whileInView={{scale:1}}
        className="bg-slate-900 flex flex-col gap-4 items-center justify-center absolute h-full p-4 rounded-3xl bg-opacity-50">
            <motion.button
            whileHover={{scale: 1.1}}
            whileTap={{scale: 0.8}}
