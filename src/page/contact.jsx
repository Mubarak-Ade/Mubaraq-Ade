            ...
            <div className="m-4 w-[30rem] place-self-center form">
                ...
                <div className="p-4 bg-white rounded-3xl relative self-center">
                    <form action="" className=''>
                        ...
                        <textarea name="Enter your Message" placeholder='write your project' id="msg" className='w-96 h-60 m-4 p-4 border border-gray-500 rounded-2xl bg-white' ></textarea><br />
